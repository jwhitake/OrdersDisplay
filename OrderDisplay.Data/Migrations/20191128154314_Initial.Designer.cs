...
namespace OrderDisplay.Data.Migrations
{
    ...
    [Migration("20191128154314_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrdersDisplay.Domain.Order", b =>
                {
                    ...
                    b.Property<string>("OrderPurchaseOrderId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("OrderPurchaseOrderId");
            ...
            modelBuilder.Entity("OrdersDisplay.Domain.Order", b =>
                {
                    b.HasOne("OrdersDisplay.Domain.Order", null)
                        .WithMany("Orders")
                        .HasForeignKey("OrderPurchaseOrderId");
                });
